package br.com.cinesky.controls;
...
public class FullscreenVideoLayout extends FullscreenVideoView implements View.OnClickListener, SeekBar.OnSeekBarChangeListener, MediaPlayer.OnPreparedListener, View.OnTouchListener {
    ...
    protected void init() {
        ...
        this.videoControlsView = inflater.inflate(R.layout.video_stream, null);
    ...
    protected void updateControls() {
        ...
        if (getCurrentState() == State.STARTED) {
            icon = context.getResources().getDrawable(R.drawable.pause);
        } else {
            icon = context.getResources().getDrawable(R.drawable.play);
        }
